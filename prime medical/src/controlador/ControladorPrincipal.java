...
public class ControladorPrincipal implements ActionListener, KeyListener {
    ...
    public ControladorPrincipal(Principal v, AgregarCarritoo view, Pagar pa) {
        this.Vista = v;
        this.Vista.VistaProveedor.addActionListener(this);
        this.Vista.VistaInventario.addActionListener(this);
        this.Vista.VistaProductos.addActionListener(this);
        this.VistaA = view;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource().equals(Vista.VistaProveedor)) {
        ...
        if (ae.getSource().equals(Vista.VistaInventario)) {
        ...
        if (ae.getSource().equals(Vista.VistaProductos)) {
    ...
    public void keyReleased(KeyEvent ke) {
        if (ke.getSource().equals(VistaA.Codigo)) {
            ...
            Principal.elements.setText("hola");
            Vista.elementos1.setText("nea");
